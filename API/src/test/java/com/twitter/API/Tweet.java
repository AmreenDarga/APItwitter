...
public class Tweet extends baseClass{	 
  ...
  public void run(){
    ...
    Response res=given().auth().oauth(consumer_key,consumer_secret,token,token_secret).queryParam("status", "i am excited to learn trending technologies111 #qualitest").when().
